    ...
    create table `sponsor_commercial_banner` (
       `sponsor_id` integer not null,
        `commercial_banners_id` integer not null
    ) engine=InnoDB;

    create table `sponsor_credit_card` (
       `sponsor_id` integer not null,
        `credit_cards_id` integer not null
    ) engine=InnoDB;

    create table `sponsor_non_commercial_banner` (
       `sponsor_id` integer not null,
        `non_commercial_banners_id` integer not null
    ) engine=InnoDB;
...
create index IDXlrvsw21ylkdqa1shrkwg1yssx on `request` (`deadline`);
    ...
    alter table `sponsor_commercial_banner` 
       add constraint UK_huxm3nxxgtlibwbvhtyimyxjh unique (`commercial_banners_id`);

    alter table `sponsor_credit_card` 
       add constraint UK_jpthnx3ff1g04bhupej95yyek unique (`credit_cards_id`);

    alter table `sponsor_non_commercial_banner` 
       add constraint UK_gks3t9jy5cfo3ov1nixb3m354 unique (`non_commercial_banners_id`);
    ...
    alter table `sponsor_commercial_banner` 
       add constraint `FKhkuqo775kcnn6dhfx2rom9vxe` 
       foreign key (`commercial_banners_id`) 
       references `commercial_banner` (`id`);

    alter table `sponsor_commercial_banner` 
       add constraint `FKqac66ts1tvlks9udr9wii6v36` 
       foreign key (`sponsor_id`) 
       references `sponsor` (`id`);

    alter table `sponsor_credit_card` 
       add constraint `FKt0sa58b5v36v0jsrw0vnq3g00` 
       foreign key (`credit_cards_id`) 
       references `credit_card` (`id`);

    alter table `sponsor_credit_card` 
       add constraint `FKiuxseh035tds7d7nhn2eq4yp` 
       foreign key (`sponsor_id`) 
       references `sponsor` (`id`);

    alter table `sponsor_non_commercial_banner` 
       add constraint `FKyd2w2fypnhvu2rqdx8gvef6k` 
       foreign key (`non_commercial_banners_id`) 
       references `non_commercial_banner` (`id`);

    alter table `sponsor_non_commercial_banner` 
       add constraint `FKfk1oyb4q1ptp7ggp317y7o30p` 
       foreign key (`sponsor_id`) 
       references `sponsor` (`id`);
