...
@Service
public class AdministratorNCBannerUpdateService implements AbstractUpdateService<Administrator, NonCommercialBanner> {

	@Autowired
	AdministratorNCBannerRepository repository;
