...
public class AuthenticatedInvestorListService implements AbstractListService<Authenticated, Investor> {
	...
	//AbstractListService<Authenthicated, Investor> interface
	...
	/*
	 * public Collection<Investor> findTopList(final Request<Investor> request) {
	 * assert request != null;
	 * Collection<Investor> result;
	 * result = this.repository.findTopList();
	 *
	 * return result;
	 * }
	 */
